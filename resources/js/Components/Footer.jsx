        ...
        <footer className="bg-primary text-primary-foreground mt-20">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    {/* Social media */}
                    <div>
                        <h3 className="font-semibold mb-2">{t("footer.follow_us")}</h3>
                        <p className="text-sm opacity-80 mb-4">{t("footer.follow_us_desc")}</p>
                        <div className="flex flex-wrap gap-3">
                            {socialLinks.map((s) => (
                                <a
                                    ...
                                    className="h-9 w-9 rounded-full bg-primary-foreground/10 hover:bg-primary-foreground/25 flex items-center justify-center transition-colors"
                                >
                                    {s.icon}
                                </a>
                            ))}
